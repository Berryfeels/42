...
void	test_nullchar_after_percent(void)
{
	int	x;
	int	y;
	...
	y = 0;
	printf ("\n----------- TEST: \0 after % -----------\n\n");
	printf("Testing: (\"\\tHel%\0lo!\\n\")\n");
	x += printf ("  Or\t:\tHel%\0lo!\n");
	y += ft_printf("  Ft\t:\tHel%\0lo!\n");
	printf("Printf = %d, ft_printf = %d\n\n", x, y);
}
...
int	main(void)
{
	...
	test_all();
	test_empty();
	test_nullchar_after_percent();
	return (0);
}

// run with: cc -o ft_tester test.c -L. -lftprintf
